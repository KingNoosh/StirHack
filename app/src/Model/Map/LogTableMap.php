...
class LogTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'App.Model.Map.LogTableMap';
     ...
     */
    const OM_CLASS = '\\App\\Model\\Log';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'App.Model.Log';
     ...
     */
    const COL_TIMESTAMP = 'log.timestamp';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Timestamp', 'Data', ),
        self::TYPE_CAMELNAME     => array('id', 'timestamp', 'data', ),
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID, LogTableMap::COL_TIMESTAMP, LogTableMap::COL_DATA, ),
        self::TYPE_FIELDNAME     => array('id', 'timestamp', 'data', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Timestamp' => 1, 'Data' => 2, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'timestamp' => 1, 'data' => 2, ),
        self::TYPE_COLNAME       => array(LogTableMap::COL_ID => 0, LogTableMap::COL_TIMESTAMP => 1, LogTableMap::COL_DATA => 2, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'timestamp' => 1, 'data' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\App\\Model\\Log');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LogTableMap::COL_TIMESTAMP);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \App\Model\Log) { // it's a model object
