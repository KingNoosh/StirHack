...
abstract class Log implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\App\\Model\\Map\\LogTableMap';
    ...
    /**
     * Initializes internal state of App\Model\Base\Log object.
     */
     ...
     * @return $this|\App\Model\Log The current object (for fluent API support)
     */
    ...
    public function setTimestamp($v)
    {
        ...
        if ($this->timestamp !== $v) {
            $this->timestamp = $v;
            $this->modifiedColumns[LogTableMap::COL_TIMESTAMP] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LogTableMap::translateFieldName('Timestamp', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\App\\Model\\Log'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LogTableMap::COL_TIMESTAMP)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\App\Model\Log The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LogTableMap::COL_TIMESTAMP)) {
            $criteria->add(LogTableMap::COL_TIMESTAMP, $this->timestamp);
        }
        if ($this->isColumnModified(LogTableMap::COL_DATA)) {
     ...
     * objects.
     *
     * @param      object $copyObj An object of \App\Model\Log (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \App\Model\Log Clone of current object.
     * @throws PropelException
     */
